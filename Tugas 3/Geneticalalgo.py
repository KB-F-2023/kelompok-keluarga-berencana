...
def changeChromosome(li):
    ...
    while newchange != 0:
        newchange = 0
        tmpli = li
        getHeur = getHeuristic(tmpli)
        index = getHeur.index(max(getHeur))
